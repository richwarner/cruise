/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: 94ef567ac5f444320696d6d46f4fb9c9)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "TripPlannerAgent" | "DispatchDirectorAgent";
	}
	interface Env {
		AI: Ai;
		TripPlannerAgent: DurableObjectNamespace<import("./src/server/index").TripPlannerAgent>;
		DispatchDirectorAgent: DurableObjectNamespace<import("./src/server/index").DispatchDirectorAgent>;
	}
}
